...
export const profileUpdate = async (profileId: number, data: IUpdateProfile, accessToken: string) => {
  const res = await axios.put(`${apiAddress}/api/profiles/${profileId}`, data, {
